...
public class ShreeRamDutayaNamah extends BaseActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawableID = MainFragment.MAHA_MRITYUNJAYA;
        mantraText = getResources().getString(R.string.my_mantra_new7);
...
//        animat();
        ...
        player = MediaPlayer.create(ShreeRamDutayaNamah.this, R.raw.shreeramdutaayenamh
        );
        seekBar.setMax(0);
