...
public class OmAnjaneyaMantra extends BaseActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawableID = MainFragment.LAXMI_JI;
        mantraText = getResources().getString(R.string.my_mantra_new6);
...
//        animat();
        ...
        player = MediaPlayer.create(OmAnjaneyaMantra.this, R.raw.omanjaneya);
        seekBar.setMax(0);
