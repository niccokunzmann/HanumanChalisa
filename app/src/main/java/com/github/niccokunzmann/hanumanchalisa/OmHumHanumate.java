...
public class OmHumHanumate extends BaseActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawableID = MainFragment.MAHA_KALI;
        mantraText = getResources().getString(R.string.my_mantra_new4);
...
//        animat();
        ...
        player = MediaPlayer.create(OmHumHanumate.this, R.raw.omhumhanumate);
        seekBar.setMax(0);
